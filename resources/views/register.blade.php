                ...
                <div class="card rounded-3 shadow p-3">
                    ...
                    <div class="card-body">
                      ...
                      <form action="/register" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="w-100 btn btn-lg btn-primary border-0 mt-3" type="submit" style="background-color: #4dab6e"><span data-feather="user-plus"></span>&nbsp; Register</button>
                    </form>
                    <small class="d-block text-center mt-3">Already registered? <a href="/login" class="text-decoration-none" style="color: #4dab6e">Login Now!</a></small>
                    </div>
                </div>
            </div>
        </div>
