...
@section('container')
    ...
    <div class="row mt-5" style="color: #4dab6e">
        ...
        {{-- Form Add Product --}}
        <form action="/admin/doctor" method="POST" class="mb-5" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="specialist" class="form-control @error('specialist')
                            is-invalid
                        @enderror" id="specialist" autofocus required value="{{ old('specialist') }}">
                        @error('specialist')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
            ...
            <div class="row text-center">
                <div class="col">
                    {{-- Button Create --}}
                    <button type="submit" class="btn btn-primary border-0" style="background-color: #4dab6e; border-color: #FEF5ED">Add Doctor</button>
                </div>
            </div>
        </form>
    </div>
