...
@section('container')
    ...
    <div class="row" style="color: #4dab6e">
        <div class="col">
            <h1>Edit Image for
                @foreach ($article_title as $name)
                    {{ $name }}
                @endforeach
            </h1>
        </div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form action="/admin/article-image/{{ $image->id }}" method="POST" class="mb-5" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col">
                                        {{-- Button Edit --}}
                                        <button type="submit" class="btn btn-primary border-0" style="background-color: #4dab6e"><span data-feather="edit"></span>&nbsp; Edit Image</button>
                                    </div>
                                </div>
                            </form>
                        </div>
