...
@section('container')
    ...
    <div class="row mt-5" style="color: #4dab6e">
        ...
        {{-- Form Add Product --}}
        <form action="/admin/pet-type" method="POST" class="mb-5" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row text-center">
                <div class="col">
                    {{-- Button Create --}}
                    <button type="submit" class="btn btn-primary border-0" style="background-color: #4dab6e; border-color: #FEF5ED">Add Pet Type</button>
                </div>
            </div>
        </form>
    </div>
